...
//                                             WARNING!!!
// Make sure that you have selected ESP32 Wrover Module in file "camera.h", or another board which has PSRAM enabled
...
const char* token =  "xxxxxxxxxx:xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
